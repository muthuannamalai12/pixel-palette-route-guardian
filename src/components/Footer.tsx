      ...
      <div className="pixel-palette-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm max-w-xs">
              Crafting pixel-perfect digital experiences with minimalist design principles.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/portfolio" className="text-muted-foreground hover:text-foreground text-sm transition-colors">Portfolio</Link></li>
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-muted-foreground text-sm">
              ...
              <p className="mt-2">contact@pixelpalette.com</p>
              <p>+1 (555) 123-4567</p>
            </address>
          </div>
        </div>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © {new Date().getFullYear()} Pixel Palette. All rights reserved.
          </p>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <motion.a whileHover={{ y: -3 }} href="#" className="text-muted-foreground hover:text-foreground transition-colors">
